                    ...
                    if (strlen($_POST['phone_number']) == 10) {
                        ...
                        if (!empty($_FILES['profile_img']['name'])) {
                            ...
                            if (preg_match('*.jpg|.png|.jpeg*i', $profile['name'])) {
                                $actual_path = 'C:\xampp\htdocs\website\project\panels\admin-panel\profile\profile-img\\' . $image_name . '';
                        ...
                        if ($ups) {
                            ...
                            <script>
                                setTimeout(() => {
                                    window.location.href = '/website/project/panels/admin-panel/profile/admin-profile.php';
                                }, 2000)
                            </script>
                        ...
                        $phone_error = "<p style='border-width:1px !important' class='text-danger border border-danger text-center mt-4'><i class='fas fa-times-circle'></i>&nbsp;&nbsp;ERROR: PHONE NUMBER SHOULD CONTAIN 10 NUMBERS</p>";
                    }
